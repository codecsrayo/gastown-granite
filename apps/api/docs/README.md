...
>
> Estado global: **Paso 7 (v1 operational + observability + real quota: hq-7pdl + hq-j9ou + hq-0bko) DONE**; **Paso 6.h A/B/C (Dolt read-side + domain-state + audit outbox: hq-u955 + hq-bdn8 + hq-7owq) DONE** (al 2026-05-28). **Paso 8/9 (cutover + Go→Rust): ver [11-cutover-roadmap.md](11-cutover-roadmap.md)** — al 2026-05-29 9.B/9.D/9.F DONE, 9.C merged, 9.A Phase 1, 9.E lifecycle DONE (mayor-spawn deferred); pendiente flip 8.4/8.6. Mantén esta tabla viva.
